...
public class testcase03 {
    ...
    public void tc03() {
        ...
        WebElement addToCartButton = driver.findElement(
                By.xpath("//*[@id=\"top\"]/body/div/div/div[2]/div/div[2]/div[1]/div[3]/ul/li[2]/div/div[3]/button"));
        ...
        WebElement updateButton = driver
                .findElement(By.xpath("//*[@id=\"shopping-cart-table\"]/tbody/tr/td[4]/button"));
        updateButton.click();
        ...
        WebElement errorMessage = driver
                .findElement(By.xpath("//*[@id=\"top\"]/body/div/div/div[2]/div/div/div/ul/li/ul/li/span"));
        ...
        // Step 6: Then click on -> EMPTY CART -> link in the footer of list of all
        // mobiles.
